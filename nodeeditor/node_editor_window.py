...
"""
import os, json
from qtpy.QtCore import QSize, QSettings, QPoint  # type: ignore
from qtpy.QtWidgets import QMainWindow, QLabel, QAction, QMessageBox, QFileDialog, QApplication  # type: ignore
...
class NodeEditorWindow(QMainWindow):
    ...
    def createStatusBar(self) -> None:  # type: ignore
    ...
    def createActions(self) -> None:  # type: ignore
